//[app](../../../../index.md)/[com.example.reminder_data_flair](../../index.md)/[MedicationHistoryAdapter](../index.md)/[MedicationHistoryViewHolder](index.md)

# MedicationHistoryViewHolder

[androidJvm]\
inner class [MedicationHistoryViewHolder](index.md)(itemView: [View](https://developer.android.com/reference/kotlin/android/view/View.html)) : [RecyclerView.ViewHolder](https://developer.android.com/reference/kotlin/androidx/recyclerview/widget/RecyclerView.ViewHolder.html)

## Constructors

| | |
|---|---|
| [MedicationHistoryViewHolder](-medication-history-view-holder.md) | [androidJvm]<br>constructor(itemView: [View](https://developer.android.com/reference/kotlin/android/view/View.html)) |
...
| Name | Summary |
|---|---|
| [bind](bind.md) | [androidJvm]<br>fun [bind](bind.md)(entry: [MedicationHistoryEntry](../../-medication-history-entry/index.md)) |
